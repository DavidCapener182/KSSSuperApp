...
export default async function TrainingAdmin() {
  ...
  if (!capabilities || (!capabilities.author && !capabilities.publisher)) return <main className="training-area"><h1>Training administration</h1><p>Course access unavailable.</p><Link href="/training-admin/assessments">Assessment administration</Link><br /><Link href="/training-admin/completions">Completion administration</Link></main>;
