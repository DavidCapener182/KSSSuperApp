...
import { OfficeOnboardingWorkspace } from "@/components/office-onboarding-workspace";
...
export default async function OnboardingPage() {
  ...
  if (principal.roles.includes("OFFICE_ADMIN") || principal.roles.includes("SUPER_ADMIN"))
    return <OfficeOnboardingWorkspace superAdmin={principal.roles.includes("SUPER_ADMIN")} />;
  return <OnboardingClient office={false} />;
}
