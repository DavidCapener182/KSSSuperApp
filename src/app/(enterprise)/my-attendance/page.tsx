...
export default async function MyAttendancePage({ searchParams }: { searchParams: Promise<{ allocationId?: string }> }) {
  ...
  return <MyAttendanceClient allocationId={allocationId} />;
}
