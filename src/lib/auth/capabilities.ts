...
export const CAPABILITIES = ["HOME", "PROFILE_SELF", "SITES_VIEW", "ACCESS_API_ADMIN", "DOCUMENT_REQUEST_CREATE", "DOCUMENT_SELF_READ", "DOCUMENT_SELF_SUBMIT", "DOCUMENT_OFFICE_REVIEW"] as const;
export type Capability = (typeof CAPABILITIES)[number];

const ROLE_CAPABILITIES: Record<RoleCode, readonly Capability[]> = {
  SUPER_ADMIN: ["HOME", "PROFILE_SELF", "SITES_VIEW", "ACCESS_API_ADMIN", "DOCUMENT_REQUEST_CREATE", "DOCUMENT_OFFICE_REVIEW"],
  OFFICE_ADMIN: ["HOME", "PROFILE_SELF", "SITES_VIEW", "DOCUMENT_REQUEST_CREATE", "DOCUMENT_OFFICE_REVIEW"],
