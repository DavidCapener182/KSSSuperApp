...
Current stage: TASK-04A People Directory implemented and development-verified; David's review remains pending. TASK-03G protected synthetic staging is accepted; independent phone access and personal UX review remain pending credential handoff.
Current authorised work: TASK-04A only. TASK-04B and TASK-05A remain proposals and require separate approval. TASK-03E was accepted at `b4b372d`; Phase 02 is closed at `b08b142`.

Phase 00: planning reviewed. Phase 01: TASK-01A through TASK-01D accepted. Phase 02: TASK-02A through TASK-02C accepted. Phase 03: TASK-03A through TASK-03G accepted; synthetic Staff credential handoff is deferred until David is at his desktop. TASK-04A is implemented in development only; Phase 05 has not started.
...
See `TASK-04A-REPORT.md` for the clean install, Webpack build, People access checks, prior regression suites and browser evidence. Webpack remains the build path; the earlier Turbopack bind issue remains technical debt.
