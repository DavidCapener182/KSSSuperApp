...
## Final visual acceptance — 25 September 2026

David subsequently reviewed and accepted the remaining synthetic Development visual evidence. **TASK-UI14 is accepted and closed in synthetic Development.** The accepted record-page anatomy covers Event, CRM Organisation, Opportunity, Incident, Onboarding, Service Delivery, the refined section-focused Mobilisation workspace, Site Service and Site Book. The final Mobilisation implementation is commit `5f105a3`, included through UI preview merge `f71895d`; its Context, Actions, Blockers, Decisions, Source links, Review and History sections, active selection and compact collapsed Change State presentation are accepted. David also accepted desktop and genuine 390px Site Service and Site Book evidence. The earlier pending-review wording above is historical and is superseded by this decision.

Site Service keeps Service state, Weekly demand template, Dated shift demand, Workforce allocation and Attendance distinct. Site Book keeps Handover, Outstanding, Recent notes, History and Add a fact. Staff Record remains under accepted UI05; Event Attendance and Event Worked Time remain focused workflow screens. This acceptance does not authorise staging, production or real data.
