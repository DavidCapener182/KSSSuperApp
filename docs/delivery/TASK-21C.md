...
Site Book, Assets, operational documents, worked time, incidents, KPIs, contracts, SLAs, finance, notifications, exports, staging, production and real KSS data are outside this slice. Further TASK-21C work needs a separate decision.
