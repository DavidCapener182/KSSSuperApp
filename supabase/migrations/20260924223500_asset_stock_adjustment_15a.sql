-- TASK-15A allow reasoned signed stock corrections without negative balances.
alter table public.asset_stock_events drop constraint asset_stock_events_quantity_check;
alter table public.asset_stock_events add constraint asset_stock_events_quantity_check check (quantity <> 0);
