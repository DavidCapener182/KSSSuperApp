-- Forward correction: retain the case ID in the safe projection CTE.
...
create or replace function public.people_directory_04a(
...
begin
  ...
  with permitted as materialized (
    ...
    select x.id, x.display_name, x.roles, x.site_names, x.current_case_id,
