...
test('01D shell route, navigation, and role boundaries', { timeout: 180000 }, async () => {
  ...
  try {
    ...
    const expected = {
      admin: ['/app', '/work', '/people', '/crm', '/sites', '/events', '/mobilisations', '/service-delivery', '/workforce', '/control-room', '/management-reports', '/assets', '/time-away', '/documents', '/operational-documents', '/onboarding', '/profile', '/incidents', '/access/incident-reviewers'], office: ['/app', '/work', '/people', '/crm', '/sites', '/events', '/mobilisations', '/service-delivery', '/workforce', '/control-room', '/management-reports', '/assets', '/time-away', '/documents', '/operational-documents', '/onboarding', '/profile'],
      staff: ['/app', '/sites', '/my-schedule', '/my-deployments', '/my-equipment', '/my-work-time', '/action-centre', '/my-availability', '/my-time-away', '/documents', '/operational-documents', '/onboarding', '/profile', '/incidents'], zero: ['/app', '/sites', '/my-schedule', '/my-deployments', '/my-equipment', '/my-work-time', '/action-centre', '/my-availability', '/my-time-away', '/documents', '/operational-documents', '/onboarding', '/profile', '/incidents'],
      operations: ['/app', '/people', '/sites', '/events', '/workforce', '/control-room', '/assets', '/time-away', '/operational-documents', '/profile'],
    };
    ...
    assert.equal((await get('/service-delivery', 'admin')).status, 200);
    assert.equal((await get('/service-delivery', 'office')).status, 200);
    assert.equal((await get('/service-delivery', 'operations')).status, 404);
