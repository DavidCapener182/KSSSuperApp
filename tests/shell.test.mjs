...
test('01D shell route, navigation, and role boundaries', { timeout: 180000 }, async () => {
  ...
  try {
    ...
    const expected = {
      admin: ['/app', '/work', '/people', '/hr', '/crm', '/sites', '/events', '/mobilisations', '/service-delivery', '/workforce', '/control-room', '/management-reports', '/assets', '/time-away', '/documents', '/operational-documents', '/onboarding', '/profile', '/incidents', '/access/incident-reviewers'], office: ['/app', '/work', '/people', '/hr', '/crm', '/sites', '/events', '/mobilisations', '/service-delivery', '/workforce', '/control-room', '/management-reports', '/assets', '/time-away', '/documents', '/operational-documents', '/onboarding', '/profile'],
