...
const paths = ['/app', '/sites', '/profile', '/people', '/workforce', '/mobilisations', '/my-schedule', '/my-deployments', '/my-work-time', '/my-attendance', '/my-availability', '/action-centre'];

test('return targets allow only implemented local routes', () => {
  for (const path of [...paths, '/sites?view=mine', '/documents', '/documents/10000000-0000-4000-8000-000000000003', '/work', '/work/10000000-0000-4000-8000-000000000003', '/onboarding', '/onboarding/10000000-0000-4000-8000-000000000003', '/people/10000000-0000-4000-8000-000000000003', '/mobilisations/10000000-0000-4000-8000-000000000003', '/events/10000000-0000-4000-8000-000000000003?requirement=10000000-0000-4000-8000-000000000004', '/events/10000000-0000-4000-8000-000000000003/attendance', '/events/10000000-0000-4000-8000-000000000003/work-time']) assert.equal(safeReturnTarget(path), path);
...
test('01D shell route, navigation, and role boundaries', { timeout: 180000 }, async () => {
  ...
  try {
    ...
    const expected = {
      admin: ['/app', '/work', '/people', '/crm', '/sites', '/events', '/mobilisations', '/workforce', '/control-room', '/documents', '/onboarding', '/profile', '/incidents', '/access/incident-reviewers'], office: ['/app', '/work', '/people', '/crm', '/sites', '/events', '/mobilisations', '/workforce', '/control-room', '/documents', '/onboarding', '/profile'],
      staff: ['/app', '/sites', '/my-schedule', '/my-deployments', '/my-work-time', '/action-centre', '/my-availability', '/documents', '/onboarding', '/profile', '/incidents'], zero: ['/app', '/sites', '/my-schedule', '/my-deployments', '/my-work-time', '/action-centre', '/my-availability', '/documents', '/onboarding', '/profile', '/incidents'],
      operations: ['/app', '/people', '/sites', '/events', '/workforce', '/control-room', '/profile'],
    };
